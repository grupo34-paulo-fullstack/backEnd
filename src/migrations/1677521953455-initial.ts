...
export class initial1677521953455 implements MigrationInterface {
    name = 'initial1677521953455'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "announcements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "year" integer NOT NULL, "km" integer NOT NULL, "price" integer NOT NULL, "description" character varying NOT NULL, "createdAt" TIMESTAMP DEFAULT '"2023-02-27T18:19:15.643Z"', "type_vehicle" character varying NOT NULL, "image" character varying NOT NULL, "is_active" boolean NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "PK_b3ad760876ff2e19d58e05dc8b0" PRIMARY KEY ("id"))`);
